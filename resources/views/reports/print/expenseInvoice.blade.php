      ...
      <div class="table-responsive">
		...
		<thead class="card-header">
          <tr>
            ...
            <td class="col-4 text-center"><strong>Outlet Name</strong></td>
            <td class="col-4 text-center"><strong>Expense</strong></td>
			<td class="col-4 text-center"><strong>Amount</strong></td>
          </tr>
        </thead>
          <tbody>
              @php
