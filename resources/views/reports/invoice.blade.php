          ...
          <div>
            <div style="margin-bottom: 10px;">
              <table style="border: none;">
                ...
                <tr>
                    <td>
                        <b class="cs-primary_color">Invoice No:</b> #{{ $sale->invoice_no }} <br>
                        <b class="cs-primary_color">Date: </b>{{ $date }}
                    </td>
                    <td style="text-align: right;">
                        <span>Rakhi Electronics</span>
                    </td>
                </tr>
                </tbody>
              </table>
            ...
            <div class="cs-invoice_head cs-mb10">
             <div>
                <table>
                    <tbody>
                    <tr>
                        <td><b class="cs-primary_color">Invoice To:</b>
                            <p>
                                {{ $sale->name }} <br>
                                {{ $sale->address }}<br>
                                {{ $sale->mobile_number }}
                        ...
                        <td style="text-align: right;"><b class="cs-primary_color">Pay To:</b>
                            <p>
                                Rakhi Enterprise <br>
              ...
              <div class="cs-round_border">
                <div class="cs-table_responsive">
                  <table>
                    <thead>
                      <tr>
                        <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">SL</th>
                        <th class="cs-width_4 cs-semi_bold cs-primary_color cs-focus_bg">Name</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($sales as $sale)
                            <tr>
                                <td class="cs-width_2">{{ $sl++ }}</td>
                                <td class="cs-width_5">{{ $sale->product_name }}</td>
                                <td class="cs-width_2">{{ $sale->price }}Tk</td>
                                <td class="cs-width_1">{{ $sale->qty }}</td>
                                <td class="cs-width_2 cs-text_right">{{ $sale->price * $sale->qty}}Tk</td>
                            </tr>
                        @endforeach
                    </tbody>
                  </table>
                    ...
                    <table>
                      <tbody>
                        <tr class="cs-border_left">
                            ...
                            <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ !empty($sale->vat) ?  $sale->vat : 0 }}%</td>
                          </tr>
                        <tr class="cs-border_left">
                          <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Special Discount</td>
                          <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ !empty($sale->special_discount) ?  $sale->special_discount : 0 }}Tk</td>
                        </tr>
                        <tr class="cs-border_left">
                          <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Discount</td>
                          <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ !empty($sale->parcent_discount) ?  $sale->parcent_discount : 0 }}%</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <table>
                    <tbody>
                      <tr class="cs-border_none">
                        ...
                        <td class="cs-width_3 cs-border_top_0 cs-bold cs-f16 cs-primary_color cs-text_right">{{ $sale->total }}Tk</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
