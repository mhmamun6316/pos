...
<div class="row">
    ...
    <div class="col-md-3">
         <div class="card card-body bg-success">
              ...
              <p class="fs-18 fw-700 text-white">৳ {{ $today_sell }}</p>
         </div>
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
         <div class="card card-body bg-dark">
              ...
              <p class="fs-18 fw-700 text-white">৳ {{ $today_expenses }}</p>
         </div>
    </div>
    <div class="col-md-3">
         <div class="card card-body bg-primary">
              <h6 class="text-white text-uppercase">Sell Profit</h6>
              <p class="fs-18 fw-700 text-white">৳ {{ $today_profit }}
              </p>
         </div>
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="card">
             <div class="card-header bg-primary d-flex justify-between">
                ...
                <a class="btn btn-success" target="blank" href="{{ route('today.sell.product') }}">PRINT</a>
             </div>
             ...
             <div class="card-body">
                <table class="example table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody id="tableBody" class="text-center">
                        @foreach ($today_sell_products as $item)
                            <tr>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="card">
            <div class="card-header bg-danger d-flex justify-between">
                ...
                <a class="btn btn-success" target="blank" href="{{ route('today.expenses') }}">PRINT</a>
           </div>
             ...
             <div class="card-body">
                <table class="example table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody id="tableBody" class="text-center">
                        @foreach ($today_expenses_datas as $item)
                            <tr>
                                <td>{{ $item->outlet_name }}</td>
                                <td>{{ $item->name }}</td>
                                <td>{{ $item->amount }}</td>
        ...
        <div class="card">
             ...
             <div class="card-body">
                <table class="example table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody id="tableBody" class="text-center">
                        @foreach ($today_due_pays as $item)
                            <tr>
                                <td>{{ $item->name }}</td>
                                <td>323</td>
                                <td>{{ $item->note }}</td>
